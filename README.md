...
## Features
  ...
  * Connections over TCP/IPv4, TCP/IPv6, Unix domain sockets or [custom protocols](https://godoc.org/github.com/zhangdapeng520/zdpgo_mysql#DialFunc)
...
Alternatively, [Config.FormatDSN](https://godoc.org/github.com/zhangdapeng520/zdpgo_mysql#Config.FormatDSN) can be used to create a DSN string by filling a struct.
...
Default:        false
```
`allowOldPasswords=true` allows the usage of the insecure old password method. This should be avoided, but is necessary in some cases. See also [the old_passwords wiki page](https://github.com/zhangdapeng520/zdpgo_mysql/wiki/old_passwords).
...
Server public keys can be registered with [`mysql.RegisterServerPubKey`](https://godoc.org/github.com/zhangdapeng520/zdpgo_mysql#RegisterServerPubKey), which can then be used by the assigned name in the DSN.
...
See the [godoc of Go-MySQL-Driver](https://godoc.org/github.com/zhangdapeng520/zdpgo_mysql "golang mysql driver documentation") for details.
...
**Caution:** As of Go 1.1, this makes `time.Time` the only variable type you can scan `DATE` and `DATETIME` values into. This breaks for example [`sql.RawBytes` support](https://github.com/zhangdapeng520/zdpgo_mysql/wiki/Examples#rawbytes).
...
## Testing / Development
To run the driver tests you may need to adjust the configuration. See the [Testing Wiki-Page](https://github.com/zhangdapeng520/zdpgo_mysql/wiki/Testing "Testing") for details.

Go-MySQL-Driver is not feature-complete yet. Your help is very appreciated.
If you want to contribute, you can work on an [open issue](https://github.com/zhangdapeng520/zdpgo_mysql/issues?state=open) or review a [pull request](https://github.com/zhangdapeng520/zdpgo_mysql/pulls).

See the [Contribution Guidelines](https://github.com/zhangdapeng520/zdpgo_mysql/blob/master/.github/CONTRIBUTING.md) for details.

---------------------------------------

## License
Go-MySQL-Driver is licensed under the [Mozilla Public License Version 2.0](https://raw.github.com/zhangdapeng520/zdpgo_mysql/master/LICENSE)
