...
var (
	...
	ErrOldPassword       = errors.New("this user requires old password authentication. If you still want to use it, please add 'allowOldPasswords=1' to your DSN. See also https://github.com/zhangdapeng520/zdpgo_mysql/wiki/old_passwords")
	...
	// See https://github.com/zhangdapeng520/zdpgo_mysql/pull/302
